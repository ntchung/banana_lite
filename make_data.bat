...
call MakeSprite.exe raven.sprite raven.dat -ja FlyerAnim.h
call MakeSprite.exe thrower.sprite thrower.dat -ja RangedAnim.h
call MakeSprite.exe troll.sprite troll.dat
call MakeSprite.exe ogre.sprite ogre.dat
call MakeSprite.exe spider.sprite spider.dat
call MakeSprite.exe shaman.sprite shaman.dat
