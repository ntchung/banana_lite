...
%JAVA_BIN%\javac -target 1.4 -source 1.4 -classpath %NOKIA_SDK_HOME%\lib\nokiaui.jar -bootclasspath %WTK_HOME%\lib\cldcapi11.jar;%WTK_HOME%\lib\midpapi20.jar _tempsrc\*.java -d _temp

echo Preverifying

%WTK_BIN%\preverify1.1 -classpath %WTK_HOME%\lib\cldcapi10.jar;%WTK_HOME%\lib\midpapi20.jar -d _temp _temp
